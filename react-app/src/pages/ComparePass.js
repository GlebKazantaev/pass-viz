    ...
    pass_label = args => {
        ...
        return (
            <div className='PassInfo'>
                <div style={{color: font_color}}>{args.target_cnt + "/" + args.ref_cnt}</div>
        ...
        return (
            <div className='ComparePass' style={{gridTemplateColumns: `${this.state.navWidth} auto`}}>
                <div className='NavigationBarCmp'>
                    ...
                    <MenuHeader backMenu={this.backMenu} back_is_active={this.state.backMenuIsActive} is_active={this.state.selectedRunTarget} />
